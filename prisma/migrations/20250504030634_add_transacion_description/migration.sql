...
INSERT INTO "new_transactions" ("account_id", "allocation_id", "amount", "created_at", "date", "id", "type", "updated_at", "user_id", "wallet_id") SELECT "account_id", "allocation_id", "amount", "created_at", "date", "id", "type", "updated_at", "user_id", "wallet_id" FROM "transactions";
