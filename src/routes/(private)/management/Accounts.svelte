...
<div class="mx-auto max-w-3xl p-4">
	...
	>
		<h1 class="mb-4 text-center text-2xl font-bold text-gray-800 dark:text-white">Mis Cuentas</h1>
				...
				<table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
					...
					>
						<tr>
							...
							<th scope="col" class="px-4 py-3">Efectivo/Virtual</th>
					...
					<tbody>
						...
						{:else}
							<tr>
								<td class="px-4 py-3 text-center" colspan="4">No hay cuentas registradas</td>
							</tr>
						{/if}
					</tbody>
				</table>
